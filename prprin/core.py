...
class PrPrInCore:
    ...
    def __init__(self, proteins=None, network=None, specie_id=9606):
        ...
        # raw data
        self.proteins = DataFrame({"symbol":[]}, index=Index([], name="stringId")) if proteins is None else proteins    # proteins in the object (indexed by string id, with the symbol)
